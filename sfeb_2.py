...
class Solder(pygame.sprite.Sprite):
    def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
        ...
        # ai
        self.move_counter = 0
        self.vision = pygame.Rect(0, 0, 600, 20)  ###############
        self.idling = False
...
enemy = Solder('enemy', 700, 365, 1.65, 5, 20, 100)
enemy2 = Solder('enemy', 400, 365, 1.65, 5, 20, 100)
#enemy3 = Solder('enemy', 500, 365, 1.65, 5, 20, 100)
